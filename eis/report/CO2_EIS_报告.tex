...
\begin{enumerate}[leftmargin=1.5cm]
  ...
  6825\,$\Omega\!\cdot\!$cm$^2$ (pH\,6.0) / 176,895\,$\Omega\!\cdot\!$cm$^2$ (pH\,6.6)。
  pH\,6.0 值（偏差 46\%）与 EIS 的 $R_{total}=3661$ 同量级，
  定量差异可能来自 Stern-Geary $B$ 常数（13--26\,mV）的不确定性
  及拟合区间内的电流噪声（$R^2=0.14$）。pH\,6.6 的 LPR 值远大于 EIS
  （偏差 96\%），但 OCP 相比 EIS 数据漂移了 111\,mV
  （$-0.695\rightarrow-0.584$\,V），证实两次测量之间 FeCO$_3$ 
  腐蚀产物层已显著增厚。LPR-EIS 的有效交叉验证需同步采集或在
  相同 OCP 条件下进行。
