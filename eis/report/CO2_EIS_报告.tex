...
pH\,6.6 的极化电阻（$R_{total} \approx 6032$ $\Omega$$\cdot$cm$^2$）
约为 pH\,6.0（$\approx 3689$ $\Omega$$\cdot$cm$^2$）的 1.6 倍，
...
$P$ & 0.8 & 0.8 \\
\midrule
$R_{total}$ ($\Omega\!\cdot\!$cm$^2$) & \textbf{6032} & \textbf{3689} \\
\bottomrule
\end{tabular}
\label{tab:params}
\end{table}
...
\begin{enumerate}[leftmargin=1.5cm]
  ...
  总极化电阻 $R_{total} \approx 6032$ $\Omega\!\cdot\!$cm$^2$，
  约为 pH\,6.0（$\approx 3689$ $\Omega\!\cdot\!$cm$^2$）的 1.6 倍
...
\begin{enumerate}[leftmargin=1.5cm]
  ...
  pH\,6.6 值（偏差 78\%）显著高于 EIS 的 $R_{total}=6032$，
  pH\,6.0 值（偏差 71\%）低于 $R_{total}=3689$。
