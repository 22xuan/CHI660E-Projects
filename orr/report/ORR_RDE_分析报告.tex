...
\begin{enumerate}[leftmargin=1.5cm]
  ...
  \item \textbf{图表输出}：Matplotlib 生成 PDF 矢量图
\end{enumerate}
...
6. OriginPro（可选） & \texttt{origin\_plot\_orr.py} & \texttt{origin\_input/} & EMF（需安装 OriginPro） \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{enumerate}[leftmargin=1.5cm]
  ...
  \item \textbf{图形双轨输出}：Matplotlib 生成 PDF 矢量图
