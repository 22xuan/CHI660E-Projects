...
半波电位负移约 73 mV，归因于无支持电解质时溶液欧姆降增大和液接电位变化。
...
\bibitem{treimer2002}
S.~E.~Treimer, D.~H.~Evans,
``Electrochemical Study of the Fe(CN)$_6^{3-}$/Fe(CN)$_6^{4-}$ Couple at an Iridium Oxide Electrode,''
\textit{Journal of the Electrochemical Society}, 2002, \textbf{149}(12), E485--E491.
